...
export default {
  shipper: 'msgraphbeat',
  collectionMethod: 'msgraphbeat-custom',
  ...
  mappingStyle: 'custom', // `custom`: will offer the Field Mapping option, or `default`: will NOT offer to do Field Mappings. If not provided, falls back to 'custom'
  skipDeploymentSteps: [
